...
//
// Verbatim, unmodified (RESEARCH.md Architecture Patterns → Pattern 1):
// the office grid is small enough that this unweighted BFS is already the
// fork's own production choice; reused as-is for this plan's IDLE-render
// pipeline and for 05-04's handoff walk-to-desk choreography.
