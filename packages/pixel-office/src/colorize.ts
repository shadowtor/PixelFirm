...
//
// Verbatim except the ColorValue import, which points at this package's own
// (trimmed) types.ts instead of the fork's VS Code webview UI component
// types module (../components/ui/types.js does not exist in this repo).
// Kept for per-agent identity colour — D-01's explicit "never conflate
// identity colour with state signal" (RESEARCH.md Pattern 2 anti-pattern).
