...
- [x] 05-37-PLAN.md — Gap closure: handoff slot reserved through the walk home (WR-08) and speaker attribution by record identity instead of dialogue text (WR-07)
...
- [x] 05-31-PLAN.md — Full-viewport sizing, border-colour surround, footer overlay (G-05-P6)

**Wave 22** *(blocked on 05-31)*

- [x] 05-32-PLAN.md — Seated at own desk whatever the status + hourglass silhouette (G-05-P3, G-05-P5)

**Wave 23** *(blocked on 05-32)*

- [x] 05-33-PLAN.md — Safe bubble placement with obstacle scoring (G-05-P1)
...
- [x] 05-37-PLAN.md — Slot held through the walk home + identity-based speaker attribution (WR-08, WR-07)
...
- [x] 06-01-PLAN.md — Tracer: a decision frame on the worker WS resolves the parked canUseTool into the exact SDK result (event + wire contract, decision mapping, parked runtime, worker broker)
- [x] 06-07-PLAN.md — Office CEO room: 24x13 grid, walled room, 4-slot ceoQueue, agents walk in and back (CEO-01)
- [x] 06-08-PLAN.md — /ceo scaffold: shadcn + Tailwind + Kibo scoped to a lazy chunk, office-bundle build check *(not autonomous — package-legitimacy checkpoint)*
...
- [x] 06-13-PLAN.md — Control-plane half: worker-socket registry, workerId stamping, dev-bypass + CSRF decision route with per-action rules

**Wave 3**

- [x] 06-03-PLAN.md — Enriched requests: readDiff, context/recommendation/links/questions, Discuss threads, restoreTask
- [x] 06-05-PLAN.md — One decision per request (migration 0004, 409s) + Cloudflare Access JWT via jose + GET /ceo/api/me + production guards
- [x] 06-06-PLAN.md — foldDecisions projection, office-feed PRIVATE filter, /ceo/ws snapshot + relay

**Wave 4**

- [x] 06-04-PLAN.md — Worker hosts ClaudeCodeRuntime; hello/bootId reconcile expiry (D-02); resume route
- [x] 06-14-PLAN.md — /ceo shell (auth/loading/empty/error states, live feed status) + live pending queue + e2e

**Wave 5**

- [x] 06-09-PLAN.md — Detail pane (runs on approve, context, recommendation, links, diff, earlier rounds) + question answering

**Wave 6**

- [x] 06-10-PLAN.md — Action bar (five actions, required notes, approve dialog, submit states) + History + Resume task

**Wave 7**

- [x] 06-11-PLAN.md — Live proof with a real Claude session (allow-rule backstop, >120 s hold, privacy backstop, evidence)

**Wave 8**

- [x] 06-12-PLAN.md — Staging: web image, Cloudflare Access on /ceo, migration 0004 on staging, guard-boundary e2e *(not autonomous — hosting `checkpoint:decision`)*
...
| 6. CEO Dashboard & Approval Workflow | 14/14 | In Progress|  |
