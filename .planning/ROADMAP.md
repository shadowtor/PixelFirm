...
- [ ] 02-01-PLAN.md — Tracer: apps/api scaffold + durable, deduped POST /events end-to-end (EVENT-02, D-04)
...
- [ ] 02-02-PLAN.md — Authenticated WS gateway + credential primitives
...
| 2. Control Plane Skeleton | 0/4 | Not started | - |
