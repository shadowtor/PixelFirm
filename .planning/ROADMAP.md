...
- [ ] 04-01-PLAN.md — Tracer: scaffold AgentRuntime/ClaudeCodeRuntime, real startTask/getStatus end-to-end

**Wave 2** *(blocked on Wave 1 completion)*

- [ ] 04-02-PLAN.md — pauseTask/resumeTask/sendMessage/cancelTask + watchdog

**Wave 3** *(blocked on Wave 2 completion)*

- [ ] 04-03-PLAN.md — requestReview/requestHandoff signal detection
